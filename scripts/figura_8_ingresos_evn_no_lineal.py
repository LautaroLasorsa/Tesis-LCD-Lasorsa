...
fig.suptitle('Ingresos vs EVN con resampleo', fontsize=40)

muestra = muestras_ingreso
...
fig.savefig("../figuras/figura_8_ingresos_evn_no_lineal.png",bbox_inches='tight')
