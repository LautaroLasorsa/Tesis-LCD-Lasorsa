...
plt.axhline(y=30, c = 'black', linewidth=4, linestyle='--',zorder=10)
...
plt.xticks(years, years, rotation=90, fontsize=14)
plt.legend(fontsize=32, loc='upper left')
plt.yticks(list(range(0,70,10)),fontsize=16, minor=False)
plt.yticks(list(range(0,65,5)),fontsize=16, minor=True)
plt.title("Disponibilidad de datos a lo largo del tiempo segun tipo de encuesta", fontsize=42)
plt.ylabel("Paises sobre los cuales hay datos", fontsize=20)
