...
fig.suptitle('C.C.de Pearson : Ingresos vs EVN con resampleo', fontsize=40)
...
yticks_mayor = np.linspace(0.55,0.95,9)
yticks_menor = np.linspace(0.55,0.95,17)
...
fig.savefig("../figuras/figura_7_pearson_ingreso_consumo_esp_vida_total_bootstrap.png",bbox_inches='tight')